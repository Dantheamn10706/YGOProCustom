...
function c120000041.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c120000041.distarget)
	...
	e2:SetOperation(c120000041.disoperation)
	...
	e3:SetTarget(c120000041.distarget)
	e3:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e3,tp)
end
function c120000041.distarget(e,c)
...
function c120000041.disoperation(e,tp,eg,ep,ev,re,r,rp)
