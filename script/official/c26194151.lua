...
function s.filter1(c,e,tp)
	local lv=c:GetLevel()
	return (c:IsSetCard(0x66) or c:IsSetCard(0x1017) or c:IsSetCard(0xa3)) and c:IsType(TYPE_SYNCHRO) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_SYNCHRO,tp,false,false)
